...
function Footer() {
  return (
    <div className='flex gap-5 w-full h-screen bg-zinc-800 p-20 font-["Founders_Grotesk_X-Condensed"] '>
        <div className='w-1/2 h-full flex flex-col justify-between'>
            <div className="heading">
               <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-15 tracking-tighter'>Eye-</h1>
               <h1 className='text-[8vw] font-semibold uppercase  leading-none -mb-15 tracking-tighter'>Opening</h1> 
            </div>
        ...
        <div className='w-1/2'>
            <h1 className='text-[6vw] font-semibold uppercase  leading-none -mb-15 tracking-tighter'>Presentations</h1>
